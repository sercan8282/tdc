  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-xl md:text-3xl font-bold text-white">IP Block Management</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg shadow">
          ...
          <p className="text-xl md:text-3xl font-bold text-red-400">{blocks.length}</p>
        </div>
        <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg shadow">
          <h3 className="text-sm text-gray-400 mb-2">Active Blocks</h3>
          <p className="text-xl md:text-3xl font-bold text-orange-400">
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 max-w-md w-full">
            <h2 className="text-lg md:text-2xl font-bold text-white mb-4">Block IP Address</h2>
            <form onSubmit={handleAddBlock} className="space-y-4">
              <div>
                <label className="block text-xs md:text-sm font-medium text-gray-300 mb-2">IP Address</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs md:text-sm font-medium text-gray-300 mb-2">Reason</label>
                <select
              ...
              <div>
                <label className="block text-xs md:text-sm font-medium text-gray-300 mb-2">Details</label>
                <textarea
              ...
              <div>
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-xs md:text-sm font-medium text-gray-300">Permanent Block</span>
                </label>
              </div>
              {!newBlock.is_permanent && (
                <div>
                  <label className="block text-xs md:text-sm font-medium text-gray-300 mb-2">Duration (hours)</label>
                  <input
                    type="number"
