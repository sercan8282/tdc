...
class UserDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'email', 'nickname', 'avatar', 'is_blocked', 'is_verified', 'is_staff', 'is_active', 'mfa_enabled', 'created_at']
...
class UserListSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'email', 'nickname', 'is_blocked', 'is_verified', 'is_staff', 'is_active', 'created_at']
